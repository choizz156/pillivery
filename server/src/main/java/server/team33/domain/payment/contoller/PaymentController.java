...
import server.team33.domain.payment.dto.KakaoPayApproveDto;
import server.team33.domain.payment.dto.KakaoPayRequestDto;
import server.team33.domain.payment.service.PayService;
import server.team33.domain.payment.service.SubsPayService;
...
//    }
    ...
    private void hasSid( KakaoPayApproveDto kakaoPayApproveDto, Long orderId){
        ...
        user.addSid(kakaoPayApproveDto.getSid());
    }
