package server.team33.domain.item.mapper;

import org.mapstruct.Mapper;
import org.springframework.data.domain.Page;
import server.team33.domain.category.dto.CategoryDto;
import server.team33.domain.category.entity.Category;
import server.team33.domain.item.dto.ItemDto.ItemCategoryResponse;
import server.team33.domain.item.dto.ItemDto.ItemDetailResponse;
import server.team33.domain.item.dto.ItemDto.ItemMainTop9Response;
import server.team33.domain.item.dto.ItemDto.post;
import server.team33.domain.item.dto.ItemSimpleResponseDto;
