...
public class DiscountCacheStrategy implements CacheStrategy<ItemQueryDto> {
	...
	public Page<ItemQueryDto> getCachedItems(CategoryName categoryName, ItemPage itemPage) {
		...
		return itemCacheManager.getCategoryItemsOnDiscount(categoryName, itemPage).toPage();
	}

	@Override
	public boolean supports(ItemSortOption itemSortOption) {

		return itemSortOption == ItemSortOption.DISCOUNT_RATE_L;
	}
}
