package team33.modulecore.domain.order.mapper;
...
import team33.modulecore.domain.order.dto.OrderDto;
import team33.modulecore.domain.order.dto.OrderDto.SimpleResponse;
...
//    }
    ...
    default List<SimpleResponse> ordersToOrderSimpleResponseDtos(List<Order> orders, ItemMapper itemMapper) {
