...
import com.team33.modulecore.core.payment.kakao.application.request.KakaoSubsRequestDispatcher;
...
class KakaoSubsRequestDispatcherTest {
	...
	void 정기_결제_요청() throws Exception {
		...
		KakaoSubsRequestDispatcher kakaoSubsRequestDispatcher =
			new KakaoSubsRequestDispatcher((params, url) -> new KakaoApiRequestResponse(), parameterProvider);

		//when
		KakaoApiRequestResponse kakaoApiRequestResponse = kakaoSubsRequestDispatcher.request(order);
