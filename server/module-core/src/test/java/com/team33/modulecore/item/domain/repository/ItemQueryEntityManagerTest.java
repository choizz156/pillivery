...
/**
 * {@linkplain TestItemQueryRepository}는 {@linkplain ItemQueryRepositoryImpl}과 로직이 동일한 가짜 대역
 * 리포지토리입니다. {@code MemoryItemRepository}에서 발견된 버그나 실패한 테스트에 대한 수정 사항은, 로직의 일관성을 유지하기 위해
...
//    private static EntityManager em;
    private static final ItemQueryRepository itemQueryRepository =
        new TestItemQueryRepository(getEmAtSuperClass());
...
//        itemQueryRepository = new TestItemQueryRepository(em);
