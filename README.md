# 최민석 | 백엔드 개발자
Java/Spring 기반의 백엔드 개발자입니다. 프로젝트 개선을 통해 성능 최적화 및 안정적인 인프라 구축을 경험했습니다.</br>
특히, 쿼리 분석과 캐싱 도입으로 서비스 응답 시간을 95% 개선하고, 멀티 모듈 전환으로 빌드 시간을 51% 단축했습니다.</br> 
현업 개발자들과의 코드 리뷰를 통해 클린 코드 작성과 협업 능력을 향상시켰습니다.</br>
